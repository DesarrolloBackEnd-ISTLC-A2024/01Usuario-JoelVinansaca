...
namespace _01Usuario_JoelVinansaca.Comunes
{
    public static class ConexionBD
    {
        ...
        {
            conexion = new SqlConnection("Server=PC14_LAB1\\SQLEXPRESS\\SQLEXPRESS;Database=PROYECTO_1;Trusted_Connection=True;");
            conexion.Open();
            return conexion;
        }
		...
		internal static void PostUsuario(Usuario objUsuario)
		{
			DataSet ds = new DataSet();
			SqlCommand cmd = new SqlCommand();
			cmd.Connection = abrirConexion();
			...
			cmd.Parameters.AddWithValue("PI_ID_USUARIO", objUsuario.codigo);
			cmd.Parameters.AddWithValue("PV_CODIGO", objUsuario.codigo);
			cmd.Parameters.AddWithValue("PV_NOMBRES", objUsuario.codigo);
			cmd.Parameters.AddWithValue("PV_APELLIDOS", objUsuario.codigo);
			cmd.Parameters.AddWithValue("PV_MAIL", objUsuario.codigo);
			cmd.Parameters.AddWithValue("PD_FECHA_NACIMIENTO", objUsuario.codigo);
			cmd.Parameters.AddWithValue("PV_CONTRASENA", objUsuario.codigo);
			cmd.Parameters.AddWithValue("PI_USUARIO_CREACION", objUsuario.codigo);


            cmd.ExecuteNonQuery();
		}

		internal static void PutUsuario(int usuarioModicficacion, Usuario objUsuario)
		{
			DataSet ds = new DataSet();
			SqlCommand cmd = new SqlCommand();
			cmd.Connection = abrirConexion();
			...
			cmd.Parameters.AddWithValue("PD_FECHA_NACIMIENTO", objUsuario.codigo);
			cmd.Parameters.AddWithValue("PV_CONTRASENA", objUsuario.codigo);
			cmd.Parameters.AddWithValue("PI_USUARIO_MODIFICACION", objUsuario.codigo);
